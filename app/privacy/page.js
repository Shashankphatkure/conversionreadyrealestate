    ...
    <div>
      ...
      <div className="px-4 md:px-8 py-4 md:py-8 max-w-6xl mx-auto bg-white shadow-lg rounded-lg my-8">
        <h2 className="text-xl md:text-2xl font-bold mb-4">
          Privacy Policy for Shree Ganesh Realty
        </h2>
        <p className="mb-4 text-sm md:text-base">
          At ShreeGaneshRealty.Com, accessible from ShreeGaneshRealty.Com, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by ShreeGaneshRealty.Com and how we use it.
        </p>
        <p className="mb-4 text-sm md:text-base">
        ...
        <p className="mb-4 text-sm md:text-base">
          ...
          shared and/or collect in ShreeGaneshRealty.Com. This policy is not
          applicable to any information collected offline or via channels other
          than this website.
        </p>
        <h2 className="text-xl md:text-2xl font-bold mb-4">Consent</h2>
        <p className="mb-4 text-sm md:text-base">
        ...
        <p className="mb-4 text-sm md:text-base">
          Like any other website, ShreeGaneshRealty.Com uses 'cookies'. These
        ...
        <p className="mb-4 text-sm md:text-base">
          ...
          advertising partners of ShreeGaneshRealty.Com.
        </p>
        <p className="mb-4 text-sm md:text-base">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on ShreeGaneshRealty.Com, which
        ...
        <p className="mb-4 text-sm md:text-base">
          Note that ShreeGaneshRealty.Com has no access to or control over these
        ...
        <p className="mb-4 text-sm md:text-base">
          ShreeGaneshRealty.Com's Privacy Policy does not apply to other
        ...
        <p className="mb-4 text-sm md:text-base">
          NewProjectsOnline.Com does not knowingly collect any Personal
